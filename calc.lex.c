...
static yyconst flex_int16_t yy_accept[22] =
    {   0,
        0,    0,   12,   11,    1,   10,    3,    8,    9,   11,
       11,   11,    2,   11,    1,    6,    4,    0,    5,    7,
        0
    } ;
...
static yyconst flex_uint16_t yy_base[22] =
    {   0,
        0,    0,   20,   21,   17,   21,   21,   21,   21,    8,
        5,    9,   21,    7,   12,   21,   21,    3,   21,   21,
       21
    } ;
...
YY_RULE_SETUP
#line 28 "calc.lex"
{yylval= new var(strdup(yytext)); return(VAR);}
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 30 "calc.lex"
